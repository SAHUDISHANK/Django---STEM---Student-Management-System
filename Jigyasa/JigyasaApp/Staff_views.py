...
from .models import Courses, CustomUser, FeedBackStaffs, LeaveReportStaff, ScheduleMeeting, SessionYearModel, ShareNotes, Staffs, Subjects, Students, Attendance,AttendanceReport
...
from .zoom_meetings import createMeeting
...
def schedule_meeting(request):
    ...
    return render(request,'dashboard/staff_template/staff_schedule_meeting.html',param)
