...
from .models import Attendance, AttendanceReport, Courses, CustomUser, FeedBackStudent, ScheduleMeeting, ShareNotes, Students, Subjects,LeaveReportStudent
...
def join_meeting(request):
    ...
    return render(request,'dashboard/student_template/student_join_meeting.html',param)